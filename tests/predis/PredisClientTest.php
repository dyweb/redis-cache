...
final class PredisClientTest extends PHPUnit_Framework_TestCase
{
    private $config;
    ...
    public function testBasic()
    {
        ...
        $this->assertInstanceOf('Dy\Redis\PredisClient', $repository->client());
    }
    ...
    {
        $this->config['connection']['client'] = 'unknown';
        $repository = new RedisRepository($this->config);
    }
}
