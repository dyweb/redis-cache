...
class PhpredisTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSet()
    {
        ...
        $this->client->sadd('testset', 'a');
        $this->client->sadd('testset', array('b'));
        $this->assertEquals(2, $this->client->scard('testset'));

        $this->client->sadd('testset', array('haha', 'huahua'));
        $this->client->sadd('testset', array('cc', 'dd', 'ee'));
        $this->client->sadd('testset', array('t1', 't2', 't3', 't4'));
        ...
        $this->client->srem('testset', array('b'));
        $this->client->srem('testset', array('a', 'huahua'));
        $this->client->srem('testset', array('cc', 'dd', 'ee'));
        $this->client->srem('testset', array('t1', 't2', 't3', 't4'));
